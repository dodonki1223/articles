...
- 並び替えられた状態なら最も高速な結合アルゴリズムになるようです。[Microsoft Docs](https://docs.microsoft.com/ja-jp/sql/relational-databases/performance/joins?view=sql-server-ver15#understanding-merge-joins) に以下のように書かれています
