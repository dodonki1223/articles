...
flowchart TD
    ...
    DEA[⭐️ AWS Certified Data Engineer - Associate]
    MLA[⭐️ AWS Certified Machine Learning Engineer - Associate]

    %% Professional Level
    SAP[⭐️ AWS Certified Solutions Architect - Professional]
    DOP[⭐️ AWS Certified DevOps Engineer - Professional]

    %% Specialty Level
    ANS[⭐️ AWS Certified Advanced Networking - Specialty]
    SCS[⭐️ AWS Certified Security - Specialty]
    MLS[⭐️ AWS Certified Machine Learning - Specialty]

    %% Relation
    SAP --> SAA[AWS Certified Solutions Architect - Associate]
    DOP --> DVA[AWS Certified Developer - Associate]
    DOP --> SOA[AWS Certified SysOps Administrator - Associate]
    ...
    classDef associate fill:#bbf,stroke:#333,stroke-width:2px
    classDef professional fill:#bfb,stroke:#333,stroke-width:2px
    classDef specialty fill:#fbb,stroke:#333,stroke-width:2px

    class CLF,AIF foundational
    class SAA,DVA,SOA,DEA,MLA associate
    class SAP,DOP professional
    class ANS,SCS,MLS specialty
```
