# CI／CD環境も含めたRails6の開発環境が今すぐに欲しい……
...
CI（継続的インテグレーション）/CD（継続的デリバリー）環境も含めて今すぐにRails６の開発環境が欲しいんだ……しかも無料で……
...
![template_sample_rials6_db](https://raw.githubusercontent.com/dodonki1223/template_sample_rails_6/master/db/erd/template_sample_rials6_db.png)
